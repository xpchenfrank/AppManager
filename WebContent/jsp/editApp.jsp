	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<h1 class="page-header" style="font-size: 20px; margin-left: -15px;">更新应用</h1>

				<form class="form-horizontal" role="form"
					enctype="multipart/form-data"
					action="<c:url value="/am/app/edit" />" method="post">
					...
					<div class="form-group" id="previewDiv" style="display: none;">
						...
						<div class="col-sm-5">
							<img id="previewImg" src="${app[0].iconPath}" style="width: 60px; height: 60px;"></img>
						</div>
					</div>
